			...
			<div class="row" style="padding-top: 40px; padding-bottom: 150px;">
				...
				<fieldset>
					<legend class="text-center">
						<h3 style="padding-top: 20px;"><span class="glyphicon glyphicon-lock"></span>&nbsp; Student Login</h3>
					</legend>
					<form name="studentlogin" action="loginlinkstudent" method="POST">
						...
						<center>
							...
							<button type="reset" class="btn btn-primary" style="background-color: #E52727;
