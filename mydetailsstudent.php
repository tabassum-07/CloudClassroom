...
<div class="container">
	<div class="row">
		<div class="col-md-5">
			...
			<h3> <a href="welcomestudent"><?php echo "<span style='color:red'>".$userfname." ".$userlname."</span>";?></a></h3>
			<?php
			...
			<fieldset>
				...
				<form action="" method="POST" name="update">
					<table class="table table-hover">
						...
						<tr>
							<td><a href="updatedetailsfromstudent.php?eno=<?php echo $row['Eno']; ?>"><input type="button" Value="Edit" class="btn btn-info btn-sm"></a></td>
