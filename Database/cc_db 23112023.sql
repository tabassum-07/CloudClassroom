...
(5, 4, '191115031', 'Shabib Choudhury', '4', 'Hypertext markup language', 'w3 consortium', 'h3', '<br>');
...
(7, 'JavaScript', 'Inside which HTML element do we put the JavaScript?', 'What is the correct JavaScript syntax to change the content of the HTML element below?\r\n\r\n\r\n<p id=\"demo\">This is a demonstration.</p>', 'Where is the correct place to insert a JavaScript?', 'What is the correct syntax for referring to an external script called \"xxx.js\"?', 'The external JavaScript file must contain the <script> tag. True or False?'),
(8, 'Bootstrap ', 'Bootstrap 3 is mobile-first. False or  True?', 'Which class provides a responsive fixed width container?', ' Which class provides a full width container, spanning the entire width of the viewport?', 'The Bootstrap grid system is based on how many columns?', 'Which class adds zebra-stripes to a table?'),
(9, 'jQuery', ' jQuery uses CSS selectors to select elements?  True or False?', 'Which sign does jQuery use as a shortcut for jQuery?', 'Look at the following selector: $(\"div\"). What does it select?', 'Is jQuery a library for client scripting or server scripting?', 'Is it possible to use jQuery together with AJAX?');
...
(101, 'Jubayer Mahmud', 'N/A', 'Modina Market, Bangladesh', 'Male', '1990-04-13', 'Sylhet', '1234', 1459384578),
(102, 'Shaikh Khan', 'N/A', 'Boshundhora, Bangladesh', 'Male', '1998-01-03', 'Dhaka', '1234', 1638592305),
(103, 'Farhan Rashid', 'N/A', 'Uposhohor, Bangladesh', 'Male', '1980-02-20', 'Sylhet', '1234', 1285935408),
(104, 'Farhana Islam', 'N/A', 'Taltola, Bangladesh', 'Female', '1996-03-05', 'Dhaka', '1234', 1578327485),
(105, 'Rita Ahmed', 'N/A', 'Mirpur, Bangladesh', 'Female', '1996-11-10', 'Dhaka', '1234', 1964738462),
(106, 'Suchi Saha', 'N/A', 'Fultola, Bangladesh', 'Female', '1998-04-03', 'Khulna', '1234', 1324387654);
...
('What is this system? willing to know', '', 'rifat@gmail.com', 14),
('How to pay fees?', '', 'shabib@gmail.com', 15);
...
(191115000, 'Neevita', 'Das', 'Utpol Das', 'Bagbari, Sylhet, Bangladesh', 'Female', 'M.Com', '1998-08-03', 1836492740, '1234', 'neevita@gmail.com'),
(191115002, 'Nasrin', 'Akter', 'Sumon Akter', 'Shamimabad, Sylhet, Bangladesh', 'Female', 'B.Com', '1999-05-12', 1925016478, '1234', 'nasrin@.com'),
(191115008, 'Mahmuda', 'Akter', 'Kamal Akter', 'Chatok, Sylhet, Bangladesh', 'Female', 'MTE', '1998-02-08', 1984637298, '1234', 'mahmuda@gmail.com'),
(191115009, 'Tanzim', 'Choudhury', 'Tahmid Choudhury', 'Hobiganj, Sylhet,Bangladesh', 'Male', 'BCA', '1997-01-16', 1736489264, '1234', 'tanzim@gmail.com'),
(191115018, 'Rifat ', 'Rahman', 'Rafiq Rahman', 'Moglabazar, Sylhet, Bangladesh', 'Male', 'M.COM.', '1996-02-10', 1627489376, '1234', 'rifat@gmail.com'),
(191115031, 'Shabib', 'Choudhury', 'Shihab Choudhury', 'Uposhohor, Sylhet, Bangladesh', 'Male', 'MCA', '1997-09-05', 1738592345, '1234', 'shabib@gmail.com'),
(191115100, 'Prapti', 'Das', 'Krishno Das', 'Shibgonj, Sylhet, Bangladesh', 'Female', 'IT', '2000-08-05', 1836283629, '1234', 'prapti@gmail.com'),
(191115200, 'Raj', 'Komol', 'Koushik Deb', 'Gopaltila, Sylhet, Bangladesh', 'male', 'MCA', '2002-02-24', 1863906234, '1234', 'raj@gmail.com'),
(191115250, 'Fahmida', 'Faiza', 'Khokon Mia', 'Khulna, Bangladesh', 'Female', 'MCA', '1998-11-05', 1738925403, '1234', 'faiza@gmail.com');
...
--
ALTER TABLE `studenttable`
  MODIFY `Eno` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=191115252;
