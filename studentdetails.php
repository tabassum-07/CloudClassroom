...
<th>Delete</th>		
			...
			?>
				...
				<tr>
					...
					<td><a href="studentdetails.php?deleteid=<?php echo $row['Eno']; ?>"><input type="submit" Value="Delete" name="delete" class="btn btn-danger btn-sm"></a>
					</td>
				</tr>
			<?php } ?>
			</table>
			<a href="addnewstudent"><button type="button" value="AddNewStudent" class="btn btn-success btn-sm">Add New Student</button></a>
		</div>
	</div>
	</div>
