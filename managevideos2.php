					...
					<form action="" method="POST" name="UpdateVideo">
						<table class="table table-hover">
							...
							<tr>
								...
								<td>
									<textarea name="V_Title" rows="1" cols="50"><?php $V_Title = $row['V_Title'];
																				echo $V_Title; ?></textarea>
								</td>
							...
							<tr>
								...
								<td>
									<textarea name="V_Url" rows="5" cols="150"><?php $V_Url = $row['V_Url'];
																				echo $V_Url; ?></textarea>
								</td>
							</tr>
							<tr>
								...
								<td>
									<textarea name="V_Remarks" rows="5" cols="150"><?php $V_Remarks = $row['V_Remarks'];
																					echo $V_Remarks; ?></textarea>
								</td>
							</tr>
						...
						if (isset($_POST['update'])) {
							...
							if (mysqli_query($connect, $sql)) {
								echo "
								<script>alert( 'Update Success.'); window.location = 'managevideos.php';
				</script>
								";
							} else {
