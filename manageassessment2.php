					...
					<form action="" method="POST" name="UpdateAssessment">
						<table class="table table-hover">
							...
							<tr>
								...
								<td>
									<textarea name="ExamName" rows="1" cols="50"><?php $ExamName = $row['ExamName'];
																					echo $ExamName; ?></textarea>
								</td>
							...
							<tr>
								...
								<td>
									<textarea name="Q1" rows="5" cols="150"><?php $Q1 = $row['Q1'];
																			echo $Q1; ?></textarea>
								</td>
							</tr>
							<tr>
								...
								<td>
									<textarea name="Q2" rows="5" cols="150"><?php $Q2 = $row['Q2'];
																			echo $Q2; ?></textarea>
								</td>
							</tr>
							<tr>
								...
								<td>
									<textarea name="Q3" rows="5" cols="150"><?php $Q3 = $row['Q3'];
																			echo $Q3; ?></textarea>
								</td>
							</tr>
							<tr>
								...
								<td>
									<textarea name="Q4" rows="5" cols="150"><?php $Q4 = $row['Q4'];
																			echo $Q4; ?></textarea>
								</td>
							</tr>
							<tr>
								...
								<td>
									<textarea name="Q5" rows="5" cols="150"><?php $Q5 = $row['Q5'];
																			echo $Q5; ?></textarea>
								</td>
							</tr>
						...
						if (isset($_POST['update'])) {
							...
							if (mysqli_query($connect, $sql)) {
								echo "
								<script>alert( 'Update Success.'); window.location = 'manageassessment.php';
				</script>
								";
							} else {
